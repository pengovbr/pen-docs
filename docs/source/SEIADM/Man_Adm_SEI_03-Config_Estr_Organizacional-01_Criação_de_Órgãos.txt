...
- Consultar órgão .. figure:: _static/images/ÍconeSEI_Consultar.png : permite consultar os dados cadastrados naquele órgão.
- Alterar órgão .. figure:: _static/images/ÍconeSEI_Alterar.png : permite cadastrar os dados daquele órgão (será detalhado a seguir)
- Histórico do Órgão .. figure:: _static/images/ÍconeSEI_Histórico.png : permite acessar o histórico daquele órgão
...
.. figure:: _static/images/02-01_Criacao-Orgaos_Diversos_Numeracao-NUP.png
  ...
  Fonte: https://www.gov.br/gestao/pt-br/assuntos/processo-eletronico-nacional/conteudo/numero-unico-de-protocolo-nup
...
- TIMBRE
  ...
  Importante! Ressalta-se que o formato de arquivo recomendado para a imagem é o “.png”. Como exemplo utilizaremos o Brasão da República.
