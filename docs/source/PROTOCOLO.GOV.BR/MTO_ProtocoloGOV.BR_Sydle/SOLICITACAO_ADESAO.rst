...
Após o recebimento do Ofício e `seus anexos <https://www.gov.br/gestao/pt-br/assuntos/processo-eletronico-nacional/conteudo/protocolo.GOV.BR>`__ a equipe técnica entrará em contato com os pontos focais indicados para agendar a Configuração assistida, uma capacitação via chamada de vídeo que consiste em auxiliar o órgão nas configurações e orientar quanto ao uso da ferramenta. É importante ressaltar, no entanto, que o presente Manual Técnico Operacional foi desenvolvido na busca de contemplar todas as orientações necessárias para a plena implantação do Protocolo.GOV.BR por conta do próprio órgão ou entidade.

Após a configuração assistida o órgão ou entidade terá o prazo de até 10 dias úteis para realizar testes, demais configurações e treinamento de suas equipes, de modo a minimizar eventuais falhas de operação. Findo este prazo, o serviço Protocolo GOV.BR será colocado em produção, ou seja, disponibilizado à sociedade.
