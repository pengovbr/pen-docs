...
Na coluna da direita, a tela “Parâmetro de método: Criar web service” será aberta. 
Selecione o Órgão em que atua e preencha os campos: 
...
- **URL:** Endereço do webservice do SPE do órgão. O padrão do webservice do SEI é: https://[endereçoseidoórgão]/sei/ws/SeiWS.php , onde o campo [endereçoseidoórgão] representa o domínio do SPE do órgão ou entidade;
