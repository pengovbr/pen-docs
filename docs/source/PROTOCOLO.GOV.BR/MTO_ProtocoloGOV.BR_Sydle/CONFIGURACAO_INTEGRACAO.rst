...
Com o menu lateral Protocolo GOV.BR selecionado, clique no ícone |Icone_Mais-Opcoes| da segunda coluna e, em seguida, na opção Criar web service.

GIF

.. |adicionar_favoritos| image:: _static/images/Icone_Mais-Opcoes.png
   :align: middle
   :width: 30
